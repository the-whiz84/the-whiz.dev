---
name: reviewing-code
description: Provides constructive feedback, catches bugs, and fosters knowledge sharing. Use when reviewing pull requests, code changes, or mentoring developers.
---
