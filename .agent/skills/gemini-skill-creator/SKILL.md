...
description: Generates new agent skills using the Gemini Skill Creator template. Use this whenever the user wants to create a new skill or add capabilities.
---
