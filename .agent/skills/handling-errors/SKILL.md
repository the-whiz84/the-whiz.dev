...
description: Implements error handling patterns across languages (exceptions, Result types, etc.) to build resilient applications. Use when designing APIs, implementing error handling, or improving reliability.
---
